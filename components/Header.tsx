  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center group" aria-label="ZUMEN ホーム">
          <Image
        ...
        {/* Nav */}
        <nav className="flex items-center gap-5 text-sm" aria-label="メインナビゲーション">
          <Link
            href="/category"
          ...
          <a
            ...
            style={{ borderRadius: "10px", padding: "7px 16px" }}
          >
