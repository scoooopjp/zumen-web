  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-3 sm:px-4 h-14 flex items-center justify-between gap-2">
        {/* Logo */}
        <Link href="/" className="flex items-center group shrink-0" aria-label="ZUMEN ホーム">
          <Image
        ...
        {/* Nav */}
        <nav className="flex items-center gap-3 sm:gap-5 text-sm" aria-label="メインナビゲーション">
          <Link
            href="/category"
